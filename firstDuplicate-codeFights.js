...
// first duplicate number for which the second occurrence has the minimal index. In other 
//words, if there are more than 1 duplicated numbers, return the number for which the 
